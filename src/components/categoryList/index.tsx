    ...
    <div>
      <div className="globalContainer1">
        ...
        <div className="container1">
          ...
          <h2>Explore our first drop of the new season</h2>
      ...
      <div className="globalContainer1">
        ...
        <div className="container1">
          ...
          <h2>Embrace your basic needs in these elevated wardrobe essentials.</h2>
      ...
      <div className="globalContainer1">
        ...
        <div className="container1">
          ...
          <h2>Explore curated items for you and everyone on your list.</h2>
      ...
      <div className="globalContainer1">
        ...
        <div className="container1">
          ...
          <h2>Nail that New Year’s look.</h2>
      ...
      <div className="globalContainer2">
        ...
        <div className="container2">
          ...
          <h2>Want to learn more about our sustainability commitments?</h2>
