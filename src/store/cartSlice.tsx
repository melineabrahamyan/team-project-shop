...
type CartItem={
    cartQuantity: number; id: string, price: number, title : string, img : string, description : string
};
...
const cartSlice = createSlice({
  ...
  initialState,
  reducers: {
    addToCart(state, action : PayloadAction<{id: string, price: number,title: string, cartQuantity? : number, img: string, description : string}>) {
